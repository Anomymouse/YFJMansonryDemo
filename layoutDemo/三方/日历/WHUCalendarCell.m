...
-(id)initWithFrame:(CGRect)frame{
    ...
    if(self){
        ...
        _lbl.font=[UIFont boldSystemFontOfSize:ip4 ? 12.0f:14.0f];
        ...
        [view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-(==3)-[lbl(==10)]" options:0 metrics:nil views:viewDic]];
